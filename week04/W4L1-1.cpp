...
void DrawQuads() {
    ...
    // 옆면1
    glColor3f(0.0f, 1.0f, 0.0f); glVertex3f(0.0f, 0.0f, 0.5f);
    glColor3f(0.0f, 1.0f, 0.0f); glVertex3f(0.5f, 0.5f, 0.0f);
    glColor3f(0.0f, 1.0f, 0.0f); glVertex3f(0.5f, -0.5f, 0.0f);

    // 옆면2
    glColor3f(1.0f, 1.0f, 1.0f); glVertex3f(0.0f, 0.0f, 0.5f);
    glColor3f(1.0f, 1.0f, 1.0f); glVertex3f(0.5f, -0.5f, 0.0f);
    glColor3f(1.0f, 1.0f, 1.0f); glVertex3f(-0.5f, -0.5f, 0.0f);

    // 옆면3
    glColor3f(0.0f, 1.0f, 1.0f); glVertex3f(0.0f, 0.0f, 0.5f);
    glColor3f(0.0f, 1.0f, 1.0f); glVertex3f(-0.5f, -0.5f, 0.0f);
    glColor3f(0.0f, 1.0f, 1.0f); glVertex3f(-0.5f, 0.5f, 0.0f);

    // 옆면4
    glColor3f(1.0f, 0.0f, 0.0f); glVertex3f(0.0f, 0.0f, 0.5f);
